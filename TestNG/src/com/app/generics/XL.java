...
*/	    
	  ...
	  /*  setCellHeaderData(summarySheetName, 0, 0, "Category", Short.valueOf((short)13));
	    ...
	    setCellData(summarySheetName, 0, 1, "Start Time", Short.valueOf((short)9));
	    setCellData(summarySheetName, 1, 1, test_suite_startTime, Short.valueOf((short)9));
	    
	    setCellData(summarySheetName, 0, 2, "End Time", Short.valueOf((short)9));
	    setCellData(summarySheetName, 1, 2, test_suite_endTime, Short.valueOf((short)9));
	    
	    setCellData(summarySheetName, 0, 3, "Duration", Short.valueOf((short)9));
	    setCellData(summarySheetName, 1, 3, test_suite_duration + "ms", Short.valueOf((short)9));
	    ...
	    JFreeChart myPieChart = ChartFactory.createBarChart("Mobile App -Execution Status", "TC Count", "Test Set", (CategoryDataset) my_pie_chart_data, PlotOrientation.VERTICAL,true,true,false);
	      ...
	      for (int j = 0; j < class_list.getLength(); j++)
	      {
	        ...
	        for (int k = 0; k < test_method_list.getLength(); k++)
	        {
	          ...
	          if (test_method_isConfig == "")
	          {
	            ...
	            setCellData(test_name, 6, r, test_method_duration + " ms", Short.valueOf((short)9));
	          }
	        }
